						...
						<li class="nv active"><a><i class="fa fa-users"></i> <spring:message
                          ...
                          <li class="nv active"><a><i class="fa fa-user-plus"></i> <spring:message
                           ...
                           <li class="nv active"><a><i class="fa fa-line-chart"></i><spring:message
                                    ...
                                    <ul class="nav child_menu" style="display: block;">
                                        <li class="current-page"><a href="classification/coach/display.do"><spring:message
...
<%-- 										code="master.page.display" /> </a></li> --%>
						   <li class="nv active"><a><i class="fa fa-line-chart"></i><spring:message
										code="master.page.classification" /><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: block;">
                                        <li class="current-page"><a href="classification/player/display.do"><spring:message
										code="master.page.user.classification" /> </a>
										 </li>
                          ...
                          <li class="nv active"><a><i class="fa fa-user-plus"></i> <spring:message
                           ...
                           <li class="nv active"><a><i class="fa fa-heart"></i><spring:message
                             ...
                             <li class="nv active"><a><i class="fa fa-line-chart"></i><spring:message
										code="master.page.classification" /><span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: block;">
                                        <li class="current-page"><a href="classification/family/display.do"><spring:message
										code="master.page.user.classification" /> </a>
										 </li>
